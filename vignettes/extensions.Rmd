...
[`Scale`](#ggproto-scale), `Coord`, `Facet`, and other [`ggproto`
...
aesthetics are subject to coordinate transformations, whereas non-position
aesthetics are not.
</dd>
<!---------------------------------------------------------------------------->
...
* [Renders](#render) the facets by combining the panels with axes, labels, facet
  labels, etc., into a [`gtable`](#gtable).
</dd>
<!---------------------------------------------------------------------------->
