...
* `Layout$train_position`: initialize and [train](#train-scale) position
  scales.
* [`Layout$map_position`](#layout-map-position): map position (x/y) scales.
...
* `Layer$compute_geom_1`: prepare `Geom`.
...
* `Layer$compute_position`: apply position adjustments.
    ...
    * [`Position$compute_panel`](#position-compute_panel): adjust positions for
      panel.
* `Layout$reset_scales`: remove any previous [scale
  training](#ggproto-scale-train).
* `Layout$train_position`: [re-train](#ggproto-scale-train) the [position
...
<dt><a name='ggproto-scale-position'></a>Scale, Train</dt>
<dd>
