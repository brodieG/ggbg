...
options(digits=2, diffobj.pager="off", diffobj.format="html")
...
This data is stored in the `$layout` {#layout-layout} member of the [`Layout`
`ggproto`](#ggproto-layout) object.  This is what it looks like for our [example
plot](#example-plot):
