---
title: "Ggplot2 Internals - An Unofficial Reference"
...
For each layer, [map](#map-scale) data with [position
scales](#ggproto-scale-position).
...
integer aesthetics to numeric.  To see the difference to normal mapping
compare `ScaleContinuousPosition$map` to `ScaleContinuous$map`.
